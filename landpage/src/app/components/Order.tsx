...
export default function Order() {
  return (
    <div className=" my-5 flex flex-col items-center justify-center text-center bg-[#99714B] text-white p-6 sm:p-8 md:p-10 rounded-lg shadow-md w-[90%] max-w-4xl mx-auto mt-6" style={{ fontFamily: glory.style.fontFamily }}>
